        ...
        <div className="cart my-14">
            ...
            <div className="cart__items mt-5">
                <div className="item flex gap-3 items-center">
                    <img src="/img/mockdata/cart-mockdata.png" alt="cart-item" className="border border-[#BEBEBE] rounded- w-[50px] h-[50px]" />
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-2">
                            <h3 className="text-secondary font-semibold inter-tight">Anandrano <span className="text-secondary/70 font-medium text-sm">(500Ar / botte)</span></h3>
            ...
            <Button className="bg-primary-foreground text-sm w-full mt-10 py-6 rounded-xl">
                Confirmer - Total: 500 Ar
            </Button>
