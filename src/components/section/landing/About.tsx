    ...
    <section className="landing__about w-full overflow-x-hidden px-6 md:px-24 mt-10">
      <div className="container w-full flex flex-col gap-16 items-center">
        ...
        <div className="w-full h-fit grid grid-cols-1 md:grid-cols-2 gap-8 justify-center items-center">
          <div className="flex flex-col gap-4 bg-[#FBFDF7] h-[184px] justify-between p-8 rounded-xl">
          ...
          <div className="p-8 flex flex-col gap-4 bg-[#FBFDF7] rounded-xl h-[184px] justify-between">
            <p className="text-lg font-semibold">Union de deux entités</p>
            <h1 className="text-[#A1D83B] text-5xl font-bold">+250</h1>
          </div>
          <div className="md:col-span-2 h-[240px] p-8 bg-[#FBFDF7] rounded-xl">
