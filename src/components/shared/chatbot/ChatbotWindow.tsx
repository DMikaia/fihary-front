...
const ChatbotWindow: FC<WindowProps> = ({ handleClose, isOpen }): JSX.Element => {
    return (
        <div className={`chatbot-window w-full max-w-[310px] md:w-[305px] h-[390px] bg-white shadow-xl rounded-xl overflow-hidden dark:bg-darkBackground ${isOpen ? "flex flex-col" : "hidden"}`}>
