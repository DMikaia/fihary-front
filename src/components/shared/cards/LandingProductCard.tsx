...
const LandingProductCard: FC<LandingCardProps> = ({ img, price, price_type, title, className }): JSX.Element => {
    ...
    return (
        <Card className={cn("landing-product__card relative border-none rounded-lg overflow-hidden shadow-none bg-transparent h-fit flex flex-col gap-6 cursor-pointer", className)}>
            ...
            <CardContent className="p-0">
                <h3 className="text-secondary dark:text-white text-xl">
                    {title}
                </h3>
