...
export default function LandingNavResponsive({
  ...
  return (
    <div
      className={`landing__nav__responsive bg-gray h-[calc(100vh_-_92px)] mt-[92px] max-w-[290px] md:max-w-[350px] block w-full fixed right-0 -top-5 px-5 md:px-7 py-12 z-50 lg:hidden ${isOpen
